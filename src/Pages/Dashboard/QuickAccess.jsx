...
const QuickAccess = () => {
  ...
  return (
    <>
      ...
      <div className="border border-gray-700 bg-[#0f172a] w-[90%] rounded-lg">
        <h1 className="border-b border-gray-700 p-2 text-base">Quick Access</h1>
        <div className="flex justify-around items-center h-full w-full py-8">
          <div
            className="flex items-center gap-4 bg-gray-800 hover:bg-gray-700 p-4 rounded-md cursor-pointer"
          ...
          <div className="flex items-center gap-4 bg-gray-800 hover:bg-gray-700  p-4 rounded-md cursor-pointer">
            <span className="rounded-full bg-yellow-500 p-3">
              <CiReceipt />
            </span>
            <h3 className="font-bold text-sm">+ Add recipt</h3>
          </div>
          <div className="flex items-center gap-4 bg-gray-800 hover:bg-gray-700  p-4 rounded-md cursor-pointer">
            <span className="rounded-full bg-green-500 p-3">
              <TbReportAnalytics />
            </span>
